...
class WebScraper:
    ...
    def __init__(self):
        ...
        # Credenciais via variáveis de ambiente (sanitizado)
        self.token = os.environ.get("TELEGRAM_TOKEN", "SEU_TOKEN_AQUI")
        self.chat_id = os.environ.get("TELEGRAM_CHAT_ID", "SEU_CHAT_ID_AQUI")
